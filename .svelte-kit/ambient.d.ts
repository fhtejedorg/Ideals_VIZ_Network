...
declare module '$env/static/private' {
	...
	export const CH_DEF_PRINTER: string;
	...
	export const OFFICEPATH: string;
	...
	export const PROGRAMFILES32: string;
	export const PROGRAMW6432: string;
	export const PROMPT: string;
	export const PSMODULEPATH: string;
	export const PUBLIC: string;
	export const REFRESHNOW: string;
	export const RTOOLS42_HOME: string;
	export const SESSIONNAME: string;
	export const SOFTWAREARCHITECTURE: string;
	...
	export const USERSID: string;
	export const VIRTUAL_WS: string;
	...
	export const WUR_HUISSTIJL_DATUM: string;
